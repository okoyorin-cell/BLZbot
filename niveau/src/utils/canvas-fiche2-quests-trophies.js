...
/** @param {{ quests: Array<{name:string,description:string,progress:number,goal:any,rarity?:string,isNumeric?:boolean}> }} param0 */
async function renderQuestsCardFiche2({ quests }) {
